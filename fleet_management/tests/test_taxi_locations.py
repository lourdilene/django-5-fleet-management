...
class TestTaxiLocationsEndpoint(APITestCase):
    def setUp(self):
        self.trajectory1 = Trajectory.objects.create(taxi_id=1, date='2024-01-01', latitude=10.0, longitude=20.0)
        self.trajectory2 = Trajectory.objects.create(taxi_id=1, date='2024-01-01', latitude=15.0, longitude=25.0)
        self.trajectory3 = Trajectory.objects.create(taxi_id=1, date='2024-01-01', latitude=20.0, longitude=30.0)
